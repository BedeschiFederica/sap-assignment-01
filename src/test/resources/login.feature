Feature: User login
  ...
  Scenario: Successful login
    ...
    When I login with my username "marco" and my password "Secret#123"
  ...
  Scenario: Login fails without having an account
    ...
    When I login with username "marco" and the password "Secret#123"
    Then I should see an error "Username does not exist"
    And I should not access to the system

  Scenario: Login fails with wrong password
    Given I am on the login page
    And I have an account with username "marco" and password "Secret#123"
    When I login with username "marco" and the password "1234!"
